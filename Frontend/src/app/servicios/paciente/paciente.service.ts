...
export class PacienteService {
  ...
  public registrarPaciente(tipo_documento,numero_identificacion,nombres,apellido_paterno,apellido_materno,telefono,direccion,correo, estrato, fecha_nacimiento,id_grupo_familiar,id_doctor,usuario,contrasena) {
    return this.http.post<any>(this.url + 'registropaciente', { tipo_documento,numero_identificacion,nombres,apellido_paterno,apellido_materno,telefono,direccion,correo, estrato, fecha_nacimiento,id_grupo_familiar,id_doctor,usuario,contrasena })
    .pipe(map(Users => {
    return Users;
    }));
    }
